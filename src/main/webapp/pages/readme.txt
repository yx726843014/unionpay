...
3) 测试界面中的交易时一定要先配置好私钥签名证书，验签公钥证书。
                                                   ...
                                                   全渠道代收产品消费交易示例地址为：http://IP：端口/ACPSample_WuTiaoZhuan
───────────
...
ACPSample-WuTiaoZhuan
  ...
  │  │	├wutiaozhuan ┈┈┈┈┈┈┈┈┈无跳转交易相关
  │  │  │   │
  │  │  │   ├Form03_6_2_OpenCard_Back.java┈┈┈┈┈商户侧开通示例类（后台）
  │  │  │	│
  │  │  │	├Form03_6_2_OpenCard_Front.java┈┈┈┈┈银联侧开通示例类（前台）
  │  │  │	│
  │  │  │   ├Form03_6_3_OpenQuery.java┈┈┈┈┈开通查询示例类（后台）
  │  │  │	│
  │  │  │	├Form03_6_6_ConsumeSMS.java┈┈┈┈┈消费短信示例类（后台）
  │  │  │	│
  │  │  │	├Form03_6_6_OpenSMS.java┈┈┈┈┈开通短信示例类 （后台）
  │  │  │	│
  │  │  │	├Form03_6_7_Consume.java┈┈┈┈┈消费示例类 （后台）
  │  │  │	│
  │  │  │	├Form03_6_7_OpenAndConsume.java┈┈┈┈┈开通并付款示例类 （前台）  
  │  │  │	│
  │  │  │	└测试商户号777290058110097代收、实名认证交易必送验证要素配置说明.txt
  │  │  │
