...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_WuTiaoZhuan/form03_6_3_OpenQuery" target="_blank">
<p>
<label>商户号：</label>
...
<p>
<label>查询的卡号：</label>
<input id="accNo" type="text" name="accNo" placeholder="被查询的卡号" value="6216261000000000018" title="被查询的卡号，填写已经开通的卡号（测试环境使用测试卡号）" required="required"/>
</p>
<p>
<label>&nbsp;</label>
