...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_WuTiaoZhuan/form03_6_7_OpenAndConsume" target="_blank">
<p>
<label>商户号：</label>
...
<label>卡号：</label>
<input id="accNo" type="text" name="accNo" placeholder="支付卡号" value="6216261000000000018" title="测试环境用测试卡" required="required"/>
</p>
<p>

<label>&nbsp;</label>
<input type="submit" class="button" value="开通并消费" />
